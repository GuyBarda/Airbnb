<template>
    <div class="user-nav">
        <div class="user-nav-in">
            ...
            <router-link v-if="user" @click.stop="closeMenu()" to="/dashboard/host/orders">My Orders</router-link>
            <router-link v-if="user" @click.stop="closeMenu()" to="/dashboard/host/stays">My Stays</router-link>
