<template>
    <section class="destination-modal">
        <section class="common-search">
            ...
            <ul>
                <li @click="setDestination('Qatar')">
                    <div class="spot-holder"><spot-icon /></div>
                    Qatar, QA
                </li>
        ...
        <section ref="regions" class="regions">
        ...
        <!-- <section class="scrollers">
            <button @click="scroll('left')" class="scroll left">&lt;</button>
            <button @click="scroll('right')" class="scroll right">&gt;</button>
        </section> -->
    </section>
</template>
    ...
    methods: {
        ...
        scroll(direction) {
            if (this.$refs.regions) {
                const { scrollLeft, clientWidth } = this.$refs.regions
                const scrollTo =
                    direction === "left"
                        ? scrollLeft - clientWidth
                        : scrollLeft + clientWidth
                this.$refs.regions.scrollTo({
                    left: scrollTo,
                    behavior: "smooth",
                })
            }
